...
reply_list["adm_ask_date"] = "On what date do you want to open the registration for the game? (DD.MM.YYYY HH:MM)"
...
reply_list["adm_date_error"] = "Incorrect date format. Enter the date again. (DD.MM.YYYY HH:MM)"
...
reply_list["games_reserve_list"] = "List of players from reserve:"
...
reply_list["error_wrong_data_format"] = "The date is entered incorrectly, make sure that the entered data is correct (DD.MM.YYYY HH:MM)."
